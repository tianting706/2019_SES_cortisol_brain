...
function IndiviStats_Hao_spm12(Config_File)
...
ResPostFix = paralist.YourName; %Lei Hao 2017/03/10
...
fname = sprintf(['Log_individualstats_',ResPostFix,'-%d_%02d_%02d-%02d_%02d_%02.0f.log'],c); %Lei Hao 2017/03/10
diary(fname);
...
parent_folder = ReadList_Hao(parent_folder);
subjects      = ReadList_Hao(subjectlist);
numsub        = length(subjects);
sesses        = ReadList_Hao(exp_sesslist);
